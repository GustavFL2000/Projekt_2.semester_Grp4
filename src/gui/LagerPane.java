...
public class LagerPane extends GridPane {
    ...
    public void placerFadpåLager() {
        ...
        cbHylde.setItems(FXCollections.observableArrayList(
                "Hylde 1",
                "Hylde 2",
                "Hylde 3"
        ));
        ...
        cbPlads.setItems(FXCollections.observableArrayList(
                "Plads 1",
                "Plads 2",
                "Plads 3"
        ));
        ...
        btnPlacerFad.setOnAction(event -> {
            ...
            try {
                ...
                if (fad == null || reol == null ||
                        hyldeString == null || pladsString == null) {

                    throw new IllegalArgumentException(
                            "Du skal vælge fad, reol, hylde og plads"
                    );
                }
    ...
    public void opretLager() {
        ...
        Label lblLagerNavn =
                new Label("Indtast lagernavn");

        this.add(lblLagerNavn, 0, 1);

        TextField txtLagerNavn =
                new TextField();
        ...
        Label lblAntalReoler =
                new Label("Indtast antal reoler");

        this.add(lblAntalReoler, 0, 5);

        TextField txtAntalReoler =
                new TextField();
